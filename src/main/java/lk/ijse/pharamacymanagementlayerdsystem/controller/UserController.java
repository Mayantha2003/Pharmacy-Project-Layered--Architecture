...
import lk.ijse.pharamacymanagementlayerdsystem.view.tdm.UserTM;
...
public class UserController implements Initializable {
    ...
    @FXML
    private TableColumn<UserTM,String> user_Id_Column;
    @FXML
    private TableColumn<UserTM,String> user_FullName_Column;
    @FXML
    private TableColumn<UserTM,String> user_Name_Column;
    @FXML
    private TableColumn<UserTM,String> user_Password_Column;
    @FXML
    private TableColumn<UserTM,String> user_Role_Column;
    @FXML
    private TableColumn<UserTM,String> user_Contact_Column;
    @FXML
    private TableColumn<UserTM, Void> ActionCol;
    ...
    private void setDataToFields(UserTM user) {
    ...
    private void setupUserActionsColumn() {
        ActionCol.setCellFactory(param -> new TableCell<UserTM, Void>() {
...

            {
                ...
                removeButton.setOnAction(event -> {
                    UserTM selectedUser = (UserTM) getTableView().getItems().get(getIndex());
    ...
    private void deleteUserLogic(UserTM user) {
        ...
        if (confirm.showAndWait().orElse(ButtonType.CANCEL) == ButtonType.OK) {
            try {
                boolean result = userBO.deleteUser(user.getUserId());
    ...
    private void handleSaveUser() {
        ...
        try {
            ...
            if (userName.isEmpty() || !userName.matches(USER_NAME_REGEX)) {
                ...
                UserDTO userDTO = new UserDTO(userName, password, fullName, contact, role);
        ...
        try {
            ...
            if (event.getCode() == KeyCode.ENTER) {
                ...
                if (id == null || id.trim().isEmpty()) {
                    ...
                    UserDTO userDTO = userBO.searchUser(Long.parseLong(id));
    ...
    private void handleUpdateUser() {
        try {
            ...
            if (userid.isEmpty() || !userid.matches(USER_ID_REGEX)) {
                ...
                UserDTO userDTO = new UserDTO(Long.parseLong(userid), userName, password,fullName, contact, role );
